...
public class ShoeController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (followController && targetControllerAnchor != null)
        {
            ...
            Vector3 targetPosition = targetControllerAnchor.position + targetControllerAnchor.TransformDirection(new Vector3(xOffset, yOffset, zOffset));
